# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-17 06:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizapp.Quiz', unique=True)),
            ],
        ),
        migrations.AddField(
            model_name='question',
        ...
        migrations.AddField(
            model_name='answerattempt',
            name='quiz_attempt',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizapp.QuizAttempt'),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
